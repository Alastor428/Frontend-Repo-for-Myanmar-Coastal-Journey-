...
const RESTAURANT_DATA: IRestaurant[] = [
  {
    id: "1",
    name: "San Yate Aye",
    image: require("../../../assets/ngapali_restaurant/1.jpg"),
  },

];

const Naung_Oo_Restaurant_home: React.FC = () => {
  const navigation = useNavigation<any>();

  const handleRestaurantPress = (name: string) => {
    if (name === "San Yate Aye") {
      navigation.navigate("SanYateAye");
    }
  };
...
export default Naung_Oo_Restaurant_home;
