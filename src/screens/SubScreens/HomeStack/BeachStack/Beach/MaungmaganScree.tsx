...
const MaungmaganScreen: React.FC<{ navigation?: any }> = ({ navigation }) => {
  ...
  rating: 4.2,
  map: "https://maps.app.goo.gl/koLLpUh68v57QXAw5",
  description: `Maungmagan Beach is one of Myanmar’s earliest developed coastal destinations, located near Dawei. It features calm waters, coconut-lined shores, and a relaxed local vibe.

Highlights:
- Peaceful beach ideal for swimming
- Fresh seafood from nearby villages
- Easy access from Dawei
...
- Visit early morning for best views`,
  ...
  const beachPhotos = [
    { id: 1, image: require("../../../../../../assets/MaungMaGan/MMG.jpg") },
    { id: 2, image: require("../../../../../../assets/MaungMaGan/MMG1.jpg") },
    { id: 3, image: require("../../../../../../assets/MaungMaGan/MMG2.jpg") },
    { id: 4, image: require("../../../../../../assets/MaungMaGan/MMG3.jpg") },
    { id: 5, image: require("../../../../../../assets/MaungMaGan/MMG4.jpg") },
    { id: 6, image: require("../../../../../../assets/MaungMaGan/MMG5.jpg") },
...
export default MaungmaganScreen;
