...
const GwaScreen: React.FC<{ navigation?: any }> = ({ navigation }) => {
  ...
  rating: 4.3,
  map: "https://maps.app.goo.gl/ngnBnCjMhD3K5C9R6",
  description: `Gwa Beach is a quiet coastal destination in Rakhine State, offering scenic beauty and a peaceful environment.

Highlights:
- Traditional fishing villages
- Calm and uncrowded beach
- Beautiful sunsets
...
- Ideal for relaxation`,
  ...
  const beachPhotos = [
    { id: 1, image: require("../../../../../../assets/Gwa/Gwa.jpg") },
    { id: 2, image: require("../../../../../../assets/Gwa/Gwa1.jpg") },
