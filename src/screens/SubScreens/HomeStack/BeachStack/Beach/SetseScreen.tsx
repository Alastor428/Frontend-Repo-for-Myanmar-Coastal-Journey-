...
const SetseScreen: React.FC<{ navigation?: any }> = ({ navigation }) => {
  ...
  rating: 4.0,
  map: "https://maps.app.goo.gl/vu13G8YdjBoBnDYV7",
  description: `Setse Beach is a popular coastal destination near Mawlamyine, known for its long sandy shoreline and lively local atmosphere. It is a favorite weekend getaway for locals.

Highlights:
- Long sandy beach perfect for walking
- Local seafood stalls and street food
- Easy access from Mawlamyine
...
- Try local seafood dishes`,
  ...
  const beachPhotos = [
    { id: 1, image: require("../../../../../../assets/Setse/SE.jpg") },
    { id: 2, image: require("../../../../../../assets/Setse/SE1.jpg") },
